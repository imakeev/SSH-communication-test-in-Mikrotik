...
*******Установка*********
1.Скопировать каталог на диск С:\
2.Добавить в автозагрузку test_inet.vbs
3.Сделать импорт router.local.reg
4. Для настройки Mikrotik консоли набрать  
...
5. Для настройки скрипта нужно сделать
